...
if [ ! -f "cache/yolov5_b4c4_rgb_mlu270.cambricon" ]; then
  wget -O cache/yolov5_b4c4_rgb_mlu270.cambricon http://video.cambricon.com/models/MLU270/yolov5/yolov5_b4c4_rgb_mlu270.cambricon
fi
...
model_file="${CURRENT_DIR}/cache/yolov5_b4c4_rgb_mlu270.cambricon"
