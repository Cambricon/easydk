...
if [ ! -f "cache/yolov3_nhwc.model" ]; then
  wget -O cache/yolov3_nhwc.model http://video.cambricon.com/models/MLU370/yolov3_nhwc_tfu_0.5_int8_fp16.model
fi
...
if [ ! -f "cache/feature_extract_nhwc.model" ]; then
  wget -O cache/feature_extract_nhwc.model http://video.cambricon.com/models/MLU370/feature_extract_nhwc_tfu_0.5_int8_fp16.model
fi
