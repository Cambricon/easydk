...
if [ ! -f "cache/yolov3_offline.cambricon" ]; then
  wget -O cache/yolov3_offline.cambricon http://video.cambricon.com/models/MLU270/yolov3/yolov3_offline.cambricon
fi
...
model_file="${CURRENT_DIR}/cache/yolov3_offline.cambricon"
