#ifndef __CN_SENSOR_OV08A20_OBJ_H__
#define __CN_SENSOR_OV08A20_OBJ_H__
...
#define cnSensOv08a20Print(format,args...) \
do{ \
    cnLog(CN_DBG_INFO,  CN_ID_ISP, "/%s/%s/%d ov08a20 -- "format, __FILE__,__func__,__LINE__, ##args);\
} while (0)  

typedef struct _cn_ov08a20_dynamic_parm
{
...
}cn_ov08a20_dynamic_parm_t;

typedef struct _cn_ov08a20_ae_init_parm
{
    int32_t s32Again;
    int32_t s32Dgain;
    int32_t s32ExpTime;
